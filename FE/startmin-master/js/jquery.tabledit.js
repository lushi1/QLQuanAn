...
(function($) {
    ...
    $.fn.Tabledit = function(options) {
        ...
        var defaults = {
            ...
            buttons: {
                edit: {
                    ...
                    html: '<span><i class="material-icons" style="color: #FFC107">&#xE254;</i></span>',
                    action: 'edit'
                },
                delete: {
                    class: 'btn btn-sm btn-default',
                    html: '<span><i class="material-icons" style="color: #E34724;">&#xE872;</i></span>',
                    action: 'delete'
                },
                save: {
        ...
        function ajax(action)
        {
            ...
            var formdata = $table.find('.tabledit-input').serializeArray();
